 ...
 */
  ...
  jQuery.extend({
    ...
    when: function (subordinate /* , ..., subordinateN */) {
      ...
      var progressValues; var progressContexts; var resolveContexts
  ...
  jQuery.support = (function () {
    var support; var all; var a
    var input; var select; var fragment
    var opt; var eventName; var isSupported; var i
    ...
    jQuery(function () {
      var container; var marginDiv; var tds
  ...
  jQuery.fn.extend({
    ...
    addClass: function (value) {
      var classes; var elem; var cur; var clazz; var j
      var i = 0
      var len = this.length
    ...
    val: function (value) {
      var ret; var hooks; var isFunction
      var elem = this[0]
  ...
  boolHook = {
    get: function (elem, name) {
      ...
      var attr = typeof prop === 'boolean' && elem.getAttribute(name)
      var detail = typeof prop === 'boolean'
 ...
 */
  jQuery.event = {
    ...
    add: function (elem, types, handler, data, selector) {
      var tmp; var events; var t; var handleObjIn
      var special; var eventHandle; var handleObj
      var handlers; var type; var namespaces; var origType
    ...
    remove: function (elem, types, handler, selector, mappedTypes) {
      var j; var handleObj; var tmp
      var origCount; var t; var events
      var special; var handlers; var type
      var namespaces; var origType
    ...
    trigger: function (event, data, elem, onlyHandlers) {
      var handle; var ontype; var cur
      var bubbleType; var special; var tmp; var i
    ...
    dispatch: function (event) {
      ...
      var i; var ret; var handleObj; var matched; var j
      var handlerQueue = []
    ...
    handlers: function (event, handlers) {
      var sel; var handleObj; var matches; var i
      var handlerQueue = []
 ...
 */
  (function (window, undefined) {
    ...
    var rcombinators = new RegExp('^' + whitespace + '*([\\x20\\t\\r\\n\\f>+~])' + whitespace + '*')
 ...
 */
    ...
    function siblingCheck (a, b) {
      var cur = b && a
      var diff = cur && (~b.sourceIndex || MAX_NEGATIVE) - (~a.sourceIndex || MAX_NEGATIVE)
 ...
 */
        ...
        CHILD: function (type, what, argument, first, last) {
          ...
          // Shortcut for :nth-*(n)
            ...
            : function (elem, context, xml) {
              var cache; var outerCache; var node; var diff; var nodeIndex; var start
    ...
    function addCombinator (matcher, combinator, base) {
      ...
      // Check against all ancestor/preceding elements
        : function (elem, context, xml) {
          var data; var cache; var outerCache
  ...
  jQuery.fn.extend({
    ...
    domManip: function (args, table, callback) {
      ...
      var first; var node; var hasScripts
      var scripts; var doc; var fragment
      var i = 0
      var l = this.length
      var set = this
      var iNoClone = l - 1
  ...
  function getAll (context, tag) {
    var elems; var elem
    var i = 0
    var found = typeof context.getElementsByTagName !== core_strundefined ? context.getElementsByTagName(tag || '*')
  ...
  jQuery.extend({
    clone: function (elem, dataAndEvents, deepDataAndEvents) {
      var destElements; var node; var clone; var i; var srcElements
    ...
    buildFragment: function (elems, context, scripts, selection) {
      var j; var elem; var contains
      var tmp; var tag; var tbody; var wrap
      var l = elems.length
    ...
    cleanData: function (elems, /* internal */ acceptData) {
      var elem; var type; var id; var data
      var i = 0
      var internalKey = jQuery.expando
  ...
  var iframe; var getStyles; var curCSS
  var ralpha = /alpha\([^)]*\)/i
  ...
  function showHide (elements, show) {
    var display; var elem; var hidden
    var values = []
    var index = 0
  ...
  if (window.getComputedStyle) {
    ...
    curCSS = function (elem, name, _computed) {
      var width; var minWidth; var maxWidth
  ...
  jQuery.fn.load = function (url, params, callback) {
    ...
    var selector; var response; var type
    var self = this
    var off = url.indexOf(' ')
 ...
 */
  function ajaxHandleResponses (s, jqXHR, responses) {
    var firstDataType; var ct; var finalDataType; var type
  ...
  function ajaxConvert (s, response) {
    var conv2; var current; var conv; var tmp
    var converters = {}
    var i = 0
    // Work with a copy of dataTypes in case we need to modify it for conversion
    var dataTypes = s.dataTypes.slice()
    var prev = dataTypes[0]
  ...
  var xhrCallbacks; var xhrSupported
  var xhrId = 0
  ...
  function defaultPrefilter (elem, props, opts) {
    ...
    var prop; var index; var length
    var value; var dataShow; var toggle
    var tween; var hooks; var oldfire
    var anim = this
    var style = elem.style
    var orig = {}
    var handled = []
  ...
  jQuery.offset = {
    ...
    setOffset: function (elem, options, i) {
      ...
      var props = {}; var curPosition = {}; var curTop; var curLeft
